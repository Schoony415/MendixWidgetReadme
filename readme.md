...
From the xml, a type file will be autogenerated apon compile. From there you can pull in your new variables.

### Using Setters to give back to Mendix

ya pfft we gotta type up some good stuff here
